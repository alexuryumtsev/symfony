...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->normalizedIds = array(
            ...
            'appbundle\\doctrine\\hashpasswordlistener' => 'AppBundle\\Doctrine\\HashPasswordListener',
            'appbundle\\form\\editformtype' => 'AppBundle\\Form\\EditFormType',
            'appbundle\\form\\loginformtype' => 'AppBundle\\Form\\LoginFormType',
            'appbundle\\form\\regformtype' => 'AppBundle\\Form\\RegFormType',
        ...
        $this->fileMap = array(
            ...
            'AppBundle\\Doctrine\\HashPasswordListener' => 'getHashPasswordListenerService.php',
            'AppBundle\\Form\\EditFormType' => 'getEditFormTypeService.php',
            'AppBundle\\Form\\LoginFormType' => 'getLoginFormTypeService.php',
            'AppBundle\\Form\\RegFormType' => 'getRegFormTypeService.php',
            ...
            'service_locator.kpemsmx' => 'getServiceLocator_KpemsmxService.php',
            'service_locator.wp6o_h8' => 'getServiceLocator_Wp6oH8Service.php',
        ...
        $this->privates = array(
            ...
            'AppBundle\\Form\\EditFormType' => true,
            'AppBundle\\Form\\LoginFormType' => true,
            'AppBundle\\Form\\RegFormType' => true,
            ...
            'service_locator.kpemsmx' => true,
            'service_locator.wp6o_h8' => true,
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListener(0, array(0 => function () {
            return ${($_ = isset($this->services['app.doctrine.hash_password_listener']) ? $this->services['app.doctrine.hash_password_listener'] : $this->load('getApp_Doctrine_HashPasswordListenerService.php')) && false ?: '_'};
        }, 1 => 'prePersist'), 0);
        $instance->addListener(1, array(0 => function () {
            return ${($_ = isset($this->services['app.doctrine.hash_password_listener']) ? $this->services['app.doctrine.hash_password_listener'] : $this->load('getApp_Doctrine_HashPasswordListenerService.php')) && false ?: '_'};
        }, 1 => 'preUpdate'), 0);
        $instance->addListener(0, array(0 => function () {
            return ${($_ = isset($this->services['AppBundle\Doctrine\HashPasswordListener']) ? $this->services['AppBundle\Doctrine\HashPasswordListener'] : $this->load('getHashPasswordListenerService.php')) && false ?: '_'};
        }, 1 => 'prePersist'), 0);
        $instance->addListener(1, array(0 => function () {
            return ${($_ = isset($this->services['AppBundle\Doctrine\HashPasswordListener']) ? $this->services['AppBundle\Doctrine\HashPasswordListener'] : $this->load('getHashPasswordListenerService.php')) && false ?: '_'};
        }, 1 => 'preUpdate'), 0);
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('751069bdf8a2bf7421801dd9b3c4bc4fb45ad272')) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('751069bdf8a2bf7421801dd9b3c4bc4fb45ad272');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '751069bdf8a2bf7421801dd9b3c4bc4fb45ad272',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '751069bdf8a2bf7421801dd9b3c4bc4fb45ad272',
