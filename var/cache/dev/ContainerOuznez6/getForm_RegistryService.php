...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\EditFormType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\EditFormType']) ? $this->services['AppBundle\Form\EditFormType'] : $this->services['AppBundle\Form\EditFormType'] = new \AppBundle\Form\EditFormType()) && false ?: '_'};
}, 'AppBundle\\Form\\LoginFormType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\LoginFormType']) ? $this->services['AppBundle\Form\LoginFormType'] : $this->services['AppBundle\Form\LoginFormType'] = new \AppBundle\Form\LoginFormType()) && false ?: '_'};
}, 'AppBundle\\Form\\RegFormType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\RegFormType']) ? $this->services['AppBundle\Form\RegFormType'] : $this->services['AppBundle\Form\RegFormType'] = new \AppBundle\Form\RegFormType()) && false ?: '_'};
